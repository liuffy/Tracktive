...
const SiteInfo = () => (
	...
	<h4
		...
		<p 
			className="about-text">This site is built on a Ruby on Rails backend, a PostgreSQL database, and
		...
		<p 
			className="about-text">SL has had her fingers in many pies, including organic farming, educating high schoolers, and now learning how to program. 
			Like most developers, she can be found on 
		<a 
			className="link"
		...
		<br/>
		<p 
			className="about-text">Want to get in touch? You can add her on LinkedIn or e-mail her <Mailee /></p>
		<br/>
	</div>
	)
